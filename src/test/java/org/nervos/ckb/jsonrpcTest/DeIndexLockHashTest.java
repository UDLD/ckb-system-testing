...
public class DeIndexLockHashTest extends RPCTestBase {
    ...
    public void initDeIndexLockHashEnv() throws InterruptedException {
        ...
        // init ckb
        deIndexLockHashCkbSystem.initCKB();
        String addIndexerModule1 = "sed -i 's/Stats\\\", \\\"Experiment/Stats\\\", \\\"Experiment\\\", \\\"Indexer/' ckb.toml";
        deIndexLockHashCkbSystem.runCommandWithDocker(addIndexerModule1);
        // run ckb
        String ckbNode1Run = "ckb  run";
        deIndexLockHashCkbSystem.runCommandWithDocker(ckbNode1Run, "-d -it");
